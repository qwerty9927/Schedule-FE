      ...
      <Row className={style.notification}>
        ...
        <Col span={18} offset={3} className={style.messageNoti}>
          <div>
            ...
            <span> [30/4/2023] Cập nhật tính năng chỉnh sửa thông tin và màu sắc môn học trên thời khóa biểu. Sử dụng trong trường hợp muốn thay đổi tên, phòng học, màu sắc của môn học. </span>
